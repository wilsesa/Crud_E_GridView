...
namespace Crud_E_GridView
{
    public partial class Default : System.Web.UI.Page
    {
        string connectionString = @"Data Source=PC\SQLEXPRESS;Initial Catalog=PhoneBookDB;Integrated Security=True";
        ...
        void populateGridView()
        {
            ...
            else
            {
                ...
                gvPhoneBook.Rows[0].Cells[0].Text = "Nenhum dado encontrado...!";
            ...
            try
            {
                if (e.CommandName.Equals("AddNew"))
                {
                    using (SqlConnection sqlCon = new SqlConnection(connectionString))
                    {
                        ...
                        populateGridView();
                        lblSuccessMessage.Text = "Novo registro adicionado...";
        ...
        protected void gvPhoneBook_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            try
            {
                using (SqlConnection sqlCon = new SqlConnection(connectionString))
                {
                    ...
                    gvPhoneBook.EditIndex = -1;
                    populateGridView();
                    lblSuccessMessage.Text = "Registro selecionado atualizado...";
                    lblErrorMessage.Text = "";
                }
            }
            catch (Exception ex)
        ...
        protected void gvPhoneBook_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                using (SqlConnection sqlCon = new SqlConnection(connectionString))
                {
                    ...
                    sqlCmd.ExecuteNonQuery();
                    populateGridView();
                    lblSuccessMessage.Text = "Registro selecionado excluído...";
                    lblErrorMessage.Text = "";
                }
            }
            catch (Exception ex)
